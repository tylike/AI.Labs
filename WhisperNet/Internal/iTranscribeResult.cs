...
namespace Whisper
{
    ...
    public readonly struct sToken
	{
		...
		public string? text => Marshal.PtrToStringUTF8( m_text );
        /// <summary>Start and end times of the token
		/// 起始和结束时间</summary>
        public readonly sTimeInterval time;
        /// <summary>Probability of the token
		/// 令牌的概率
        /// </summary>
        public readonly float probability;
        /// <summary>Probability of the timestamp token
        /// 时间戳令牌的概率
        /// </summary>
        public readonly float probabilityTimestamp;
        /// <summary>Sum of probabilities of all timestamp tokens
        /// 所有时间戳令牌的概率总和
        /// </summary>
        public readonly float ptsum;
        /// <summary>Voice length of the token
        /// 令牌的语音长度
        /// </summary>
        ...
        /// <summary>True if the token flags has the specified bit set
        /// 如果令牌标志具有指定的位设置，则为True
        /// </summary>
