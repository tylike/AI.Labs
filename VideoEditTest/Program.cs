...
XafTypesInfo.Instance.RegisterEntity(typeof(VideoScript));
...
var script = objectSpace.GetObjectsQuery<VideoScript>().FirstOrDefault(t => t.Name == "test1");
if (script == null)
{
    script = objectSpace.CreateObject<VideoScript>();
    script.Name = "test1";
    script.VideoInfo = vi;
    script.Export();
}
