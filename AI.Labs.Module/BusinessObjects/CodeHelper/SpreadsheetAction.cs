...
namespace AI.Labs.Module.BusinessObjects.AISpreadSheet
{
    ...
    public class AICoderAction : SimpleXPObject
    {
        public AICoderAction(Session s) : base(s)
        {
    ...
    public class AICodeViewController : CustomizeDialogViewController<DetailView, CodeTask>
    {
