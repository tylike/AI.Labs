...
namespace AI.Labs.Module.BusinessObjects.AutoComplexTask
{
    ...
    public class GPTAgent : IStreamingAgent
    {
            ...
            CancellationToken cancellationToken = default)
        {
            ...
            var msg = await _innerAgent.GenerateReplyAsync(messages, options, cancellationToken);
            return msg;
        }
        ...
        public IAsyncEnumerable<IStreamingMessage> GenerateStreamingReplyAsync(
            ...
            CancellationToken cancellationToken = default)
        {
            var t = _innerAgent.GenerateStreamingReplyAsync(messages, options, cancellationToken);
            return t;
        }
    }
